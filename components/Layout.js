...
import { loadGtmIfCookieExists } from "../utils/gtm/gtm";
...
export const Layout = (props) => {
  const { children, header, footer, page, activeDocMeta, hideNavbar, consentManager } = props;
  ...
  return (
    <>
      ...
      {hideNavbar !== true && (
        <>
          {loadGtmIfCookieExists(separateUrl())}
          <Navbar
            siteTitle={""}
            topMenu={header}
            header={header}
